...
from .vk import (
    ...
    WrapMode,
    # Classes (for type annotations/intellisense; not constructed directly --
    # see module docstring). Device/Engine intentionally excluded: hidden
    # behind the device()/engine() context.
...
__all__ = [
    ...
    "VertexResolutionMode",
    "WrapMode",
    # Classes (for type annotations/intellisense)
    "AccelerationStructure",
    "ADSAABB",
    "ADSInstances",
    "ADSTriangles",
    ...
    "Window",
    "WrappedMemory",
    # Type introspection tools (vk.vk)
    "is_matrix",
    "is_scalar",
    "is_vector",
    "type_component_count",
